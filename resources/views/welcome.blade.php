            ...
            <div class="carousel-item active">
                ...
                <div class="container">
                    <div class="carousel-caption text-left carousel-background">
                        ...
                        <p>Wij willen natuurlijk de lekkerste en de meest biologische kaas, om dit te bereiken geven wij
                            onze koeien een prachtig leventje, kijk dan toch hoe blij hij is.</p>
            ...
            <div class="carousel-item">
                ...
                <div class="container">
                    <div class="carousel-caption carousel-background">
                        ...
                        <p>Omdat de lucht natuurlijk zo prachtig en mooi blauw is op deze foto, kun je met de volgende
                            actie code: "MooieBlauweLucht23,6" nu 25% korting krijgen op je allereerste aankoop!</p>
                        <p><a class="btn btn-lg btn-primary" href="/../categoryoverview" role="button">Bekijk onze
                                producten!</a></p>
                    </div>
                </div>
            </div>
            <div class="carousel-item">
                ...
                <div class="container">
                    <div class="carousel-caption text-right carousel-background">
                        ...
                        <p>De kaas hierachter ziet er toch heerlijk uit, vind je ook niet? Koop daarom nu het meest
                            verkochte product!</p>
                        <p><a class="btn btn-lg btn-primary" href="/../product/{{ $populairProduct->id }}"
                              role="button">Bekijk product</a></p>
                    </div>
                </div>
            </div>
        </div>
